/**
 * Vercel / Netlify-compatible serverless handler for Todo Flow chat.
 * Set CLAUDE_API_KEY (and optionally CLAUDE_MODEL, ALLOWED_ORIGIN) in project env.
 */
...
async function readRequestBody(req) {
  ...
  for await (const chunk of req) {
    ...
    if (len > 1_000_000) throw new Error('Request body too large');
  }
